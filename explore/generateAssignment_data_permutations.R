...
n=10
generate_assignment_data_n = function(n  ) {

  walk(1:n, generate_assignment_data)

}

generate_assignment_data = function( seed ) {
  set.seed( seed )
  ...
  write_csv( df_incorrect,
            glue( 'data/assignment/students/',seed,'_admissions_with_errors.csv'))
